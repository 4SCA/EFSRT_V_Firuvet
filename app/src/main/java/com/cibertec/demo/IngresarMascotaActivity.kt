...
class IngresarMascotaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val etRazaMascota =findViewById<com.google.android.material.textfield.TextInputEditText>(R.id.etRazaMascota)
        ...
        etRazaMascota.setOnClickListener {
            ...
            if (especie == "Perro") {
                RazaDialogHelper.mostrarDialogoRazasPerros(this) { razaSeleccionada: String ->
                    etRazaMascota.setText(razaSeleccionada)
                }
            } else {
                RazaDialogHelper.mostrarDialogoRazasGatos(this) { razaSeleccionada: String ->
                    etRazaMascota.setText(razaSeleccionada)
                }
            }
        }
